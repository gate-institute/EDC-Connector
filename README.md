...
The `gate/0.18.0` branch is the main branch used for GATE deployments of the
EDC connector. It contains some changes to EDC's `v0.17.0` tag
(ref. [911a22b](https://github.com/eclipse-edc/Connector/tree/911a22ba6b90688ffeb35bb92bf5cc040ffdf37f)),
...
[here](https://github.com/eclipse-edc/Connector/compare/v0.18.0...gate-institute:EDC-Connector:gate/0.18.0?expand=1).
...
This project builds java artifacts versioned as `0.18.0` (and not `0.18.0-gate`).
