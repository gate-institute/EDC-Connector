...
The `gate/0.16.0` branch is the main branch used for GATE deployments of the
EDC connector. It contains some changes to EDC's `v0.16.0` tag
(ref. [8f27b9c](https://github.com/eclipse-edc/Connector/tree/224b73994c52b58f2c7f5f4bb175a6c5920a6436)),
...
[here](https://github.com/eclipse-edc/Connector/compare/v0.16.0...gate-institute:EDC-Connector:gate/0.16.0?expand=1).
...
This project builds java artifacts versioned as `0.16.0` (and not `0.16.0-gate`).
...
(as of Oct 2025) is not well documented.
