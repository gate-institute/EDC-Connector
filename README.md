...
The `gate/0.15.1` branch is the main branch used for GATE deployments of the
EDC connector. It contains some changes to EDC's `v0.15.1` tag
(ref. [4f2239c](https://github.com/eclipse-edc/Connector/tree/4f2239c53de98efbd966ea5aa9378f24b5234496)),
...
[here](https://github.com/gate-institute/EDC-Connector/compare/v0.15.1...gate/0.15.1?expand=1).
...
This project builds java artifacts versioned as `0.15.1` (and not `0.15.1-gate`).
